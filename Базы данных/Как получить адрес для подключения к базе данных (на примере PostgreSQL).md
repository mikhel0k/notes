...
Названия все пишем маленькими буквами, если напишите большими то оно автоматически сделает все маленькими и потом когда будете обращаться используя заглавный буквы, он не будет ничего находить.
...
ASYNC_DATABASE_URL=postgresql+asyncpg://{имя пользователя}:{пароль}@localhost:5432/{название базы данных}
```
