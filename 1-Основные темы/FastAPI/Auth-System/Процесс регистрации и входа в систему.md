#JWT_токен #авторизация #регистрация #вход #pydantic #базы_данных #endpoints #API #FastAPI
...
И дальше надо написать API для того чтобы пользователь мог взаимодействовать [[Написание endpointов]] [[Выдача токена аутентификации]] 
